...
import { AutoCycleImage } from "../ui/AutoCycleImage";
...
export function FeaturedProducts({
  ...
  return (
    <section className="relative overflow-hidden bg-[#f4f1ea] px-4 py-11 sm:px-6 sm:py-14 lg:px-10 lg:py-16">
      {/* TOP DETAIL */}
      <div className="pointer-events-none absolute left-1/2 top-0 h-px w-2/3 -translate-x-1/2 bg-gradient-to-r from-transparent via-[#9a7b3f]/25 to-transparent" />

      {/* SOFT BACKGROUND GLOW */}
      <div className="pointer-events-none absolute -right-40 top-16 h-72 w-72 rounded-full bg-[#9a7b3f]/[0.035] blur-3xl" />
      <div className="pointer-events-none absolute -left-40 bottom-0 h-72 w-72 rounded-full bg-[#211710]/[0.025] blur-3xl" />
      ...
      <div className="relative mx-auto max-w-[1380px]">
        ...
        <div className="mb-8 flex items-end justify-between gap-6 sm:mb-10 lg:mb-12">
          <div className="flex items-start gap-4 sm:gap-5">
            {/* GOLD LINE */}
            <span className="mt-1 hidden h-16 w-px shrink-0 bg-gradient-to-b from-[#9a7b3f] via-[#9a7b3f]/50 to-transparent sm:block" />

            <div>
              {/* EYEBROW */}
              <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-[#211710]/[0.07] bg-white/65 px-3 py-1.5 shadow-[0_4px_16px_rgba(36,26,20,0.035)] backdrop-blur-sm">
                <span className="relative flex h-1.5 w-1.5">
                  <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#9a7b3f]/30" />
                  <span className="relative inline-flex h-1.5 w-1.5 rounded-full bg-[#9a7b3f]" />
                </span>

                <span className="text-[8px] font-bold uppercase tracking-[0.28em] text-[#9a7b3f]">
                  Featured Collection
                </span>
              </div>

              {/* TITLE */}
              <h2 className="max-w-[720px] font-serif text-[2rem] leading-[0.98] tracking-[-0.045em] text-[#211710] sm:text-[2.8rem] lg:text-[3.6rem]">
                The essentials{" "}
              ...
              {/* DESCRIPTION */}
              <p className="mt-3 max-w-[500px] text-[10px] leading-[1.7] text-[#211710]/42 sm:text-[11px]">
                A considered selection of customer favourites —
                trusted products chosen for quality, performance and
                everyday value.
              </p>
            </div>
          </div>
          ...
          <Link
            href="/shop"
            className="group hidden shrink-0 items-center gap-2 border-b border-[#211710]/20 pb-1.5 text-[8px] font-bold uppercase tracking-[0.2em] text-[#211710] transition-all duration-300 hover:border-[#9a7b3f] hover:text-[#9a7b3f] sm:inline-flex"
          >
            Explore Collection
        ...
        {products.length > 0 ? (
          <div className="grid grid-cols-2 gap-x-3 gap-y-7 sm:grid-cols-3 sm:gap-x-5 sm:gap-y-8 lg:grid-cols-4 lg:gap-x-6 lg:gap-y-10">
            {products.map((product) => {
              ...
              const compareAt = hasVariants
                ? variant?.compareAt ?? product.compareAt
                : product.compareAt;
              ...
              return (
                <article
                  key={product.id}
                  className="group flex h-full flex-col overflow-hidden rounded-[22px] border border-[#211710]/[0.065] bg-white shadow-[0_6px_24px_rgba(36,26,20,0.04)] transition-all duration-500 hover:-translate-y-1 hover:border-[#211710]/[0.1] hover:shadow-[0_18px_45px_rgba(36,26,20,0.09)]"
                >
                  {/* PRODUCT */}
                  <Link
                    ...
                    className="block"
                  >
                    {/* IMAGE — square stage, image never cropped */}
                    <div className="relative aspect-square w-full overflow-hidden bg-white">
                      ...
                      {/* IMAGE — generous padding, fully contained, no crop */}
                    ...
                    <div className="px-3.5 pb-3.5 pt-3.5 sm:px-5 sm:pb-4 sm:pt-4">
                      ...
                      <div className="mt-2.5 flex items-center gap-1.5">
                        <div className="flex items-center gap-1 rounded-full border border-[#211710]/[0.05] bg-[#f6f3ec] px-1.5 py-1">
                          <span className="text-[8px] text-[#9a7b3f]">
                            ★
                          </span>
          ...
          <div className="flex min-h-[200px] items-center justify-center rounded-[24px] border border-[#211710]/[0.07] bg-white shadow-[0_6px_24px_rgba(36,26,20,0.04)]">
            <p className="text-[9px] font-bold uppercase tracking-[0.22em] text-[#211710]/35">
        ...
        <div className="mt-7 sm:hidden">
          <Link
            href="/shop"
            className="group flex h-11 items-center justify-center gap-2 rounded-full border border-[#211710]/[0.09] bg-white text-[8px] font-bold uppercase tracking-[0.18em] text-[#211710]/65 shadow-[0_5px_18px_rgba(36,26,20,0.035)] transition-all duration-300 hover:border-[#9a7b3f]/40 hover:text-[#9a7b3f]"
          >
            View All Products
